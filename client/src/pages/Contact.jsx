      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Have questions about sustainable shopping? We're here to help!</p>
          </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@ecomarket.com</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
              ...
              <div className="card bg-green-50">
                ...
                <p className="text-gray-600 mb-4">
                  Need immediate help? Check out our FAQ section or start a live chat with our support team.
                </p>
